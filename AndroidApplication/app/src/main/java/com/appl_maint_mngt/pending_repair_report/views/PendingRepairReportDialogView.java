...
public class PendingRepairReportDialogView implements IPendingRepairReportView {
    ...
    public PendingRepairReportDialogView(View parent) {
        titleTV = (TextView) parent.findViewById(R.id.dialog_pending_repair_report_textview_title);
        statusTV = (TextView) parent.findViewById(R.id.dialog_pending_repair_report_textview_value_status);
