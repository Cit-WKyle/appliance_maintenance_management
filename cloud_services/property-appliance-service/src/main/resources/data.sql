...
INSERT INTO property_appliances(id, appliance_id, property_id, status_id, name, age) SELECT 6, '590bccbffb99ac2916aea6c2', 1, 4, 'PropertyAppliance6', 5 WHERE NOT EXISTS(SELECT 1 FROM property_appliances WHERE id=6)
