...
INSERT INTO property_appliances(id, appliance_id, property_id, status_id, name, age) SELECT 3, '58f539c6faccfd35d35166bd', 1, 3, 'Delete Me', 5 WHERE NOT EXISTS(SELECT 1 FROM property_appliances WHERE id=3)
